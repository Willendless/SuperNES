...
object OpcodeMap {
    ...
    private val opcodesList = arrayListOf<Opcode>(
            ...
            // Branches
            Opcode(0x90u, "BCC", 2u, Relative),
            Opcode(0xB0u, "BCS", 2u, Relative),
            Opcode(0xF0u, "BEQ", 2u, Relative),
            Opcode(0x30u, "BMI", 2u, Relative),
            Opcode(0xD0u, "BNE", 2u, Relative),
            Opcode(0x10u, "BPL", 2u, Relative),
            Opcode(0x50u, "BVC", 2u, Relative),
            Opcode(0x70u, "BVS", 2u, Relative),
            // Status Flag Changes
