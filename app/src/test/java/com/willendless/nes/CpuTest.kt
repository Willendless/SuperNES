...
class CPUTest {
    ...
    @Test fun test_lda_indirect_x() {
        cpu.memory[0x00u] = 0x0010u
        cpu.memory[0x10u] = 0x0010u
    ...
    @Test fun test_lda_indirect_y() {
        cpu.memory[0xBBu] = 0x1122u
        cpu.memory[0x1124u] = 0x00AAu
    ...
    @Test fun test_sta_zero_page() {
        ...
        cpu.loadAndRun(program)
        assertEquals(0x02.toUByte(), cpu.memory[0x01u])
    }
